...
export default function IntersectionExample() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6 dark:text-white">Schedule Intersection Example</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="border dark:border-gray-700 rounded-lg p-4 bg-blue-50 dark:bg-blue-950/30">
          <h2 className="text-xl font-semibold mb-4 text-blue-800 dark:text-blue-400">Person A</h2>
